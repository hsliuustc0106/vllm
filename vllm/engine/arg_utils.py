...
class EngineArgs:
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        parser.add_argument(
            ...
            default="merged",
            type=str,
            choices=["raw", "merged", "fusion"],
            help="Swap blocks methods: raw(original method), merged(merge contiguous blocks), fusion(fuse copies into a single kernel operation)"
        )
