...
class CacheConfig:
    ...
    """Swap blocks methods: raw(original method), merged(merge contiguous blocks), fusion(fuse copies into a single kernel operation)"""

    cache_policy: str = "lru"
    """GPU Hot Cache Policy: lru, lfu, hot-score"""
