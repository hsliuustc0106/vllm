...
class LLM:
    ...
    def _run_engine(
        ...
        while self.llm_engine.has_unfinished_requests():
            if global_debug_config.profile and step_count == global_debug_config.offline_start_profile_step:
                print("start profiling")
                self.start_profile()
            step_outputs = self.llm_engine.step()
            if global_debug_config.profile and step_count == global_debug_config.offline_end_profile_step:
